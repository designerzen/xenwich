	...
	while(_g < _g1.length) {
		...
		try {
			...
			if(typeof(_g3) == "string") {
				var e = _g3;
				haxe_Log.trace("Error deserializing line: " + e,{ fileName : "src/goldenpond/GoldenData.hx", lineNumber : 242, className : "GoldenData", methodName : "makeFromJSON"});
				continue;
			} else {
				throw _g2;
			}
...
GoldenData.prototype = {
	...
	,makeTimeManipulator: function() {
		return new TimeManipulator().setPPQ(96).setChordDuration(this.chordDuration).setBPM(this.bpm);
	}
	...
	,toJSON: function() {
		...
		var data6 = { root : data, mode : data1, chordSequence : data2, stutter : data3, bpm : data4, chordDuration : data5, lines : result};
