...
export const handleScan = (callback) => {
...
export const sendProgramChange = async (characteristic, channel, value) => {
...
export const sendControlChange = async (characteristic, channel, controlNumber, value) => {
  if (channel === null) { return null; }
  const { header, messageTimestamp } = getTimestampBytes();
